        ...
        <section className="text-gray-600 body-font relative">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-col text-center w-full mb-12">
              ...
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Have questions or need assistance with Secure Vault?</p>
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Reach out to us, and we'll get back to you as soon as possible.</p>
            </div>
            <div className="lg:w-1/2 md:w-2/3 mx-auto">
              <div className="flex flex-wrap -m-2">
                ...
                <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                  <a className="text-green-500">securevaluthelp@email.com</a>
                  <p className="leading-normal my-5">49 Smith St.
                    <br />Saint Cloud, MN 56301
                    <br/><a href="https://lordicon.com/">Icons by Lordicon.com</a>
                  </p>
